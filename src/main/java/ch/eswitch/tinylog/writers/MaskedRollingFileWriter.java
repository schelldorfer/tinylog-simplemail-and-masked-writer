...
/**
 * tinylog 2 Masked {@link org.tinylog.writers.RollingFileWriter}<br/>
 ...
 */
public final class MaskedRollingFileWriter extends AbstractFormatPatternWriter
{
     ...
     * @throws IllegalArgumentException A property has an invalid value or is missing in configuration
     */
    public MaskedRollingFileWriter() throws IOException
    {
     ...
     * @throws IllegalArgumentException A property has an invalid value or is missing in configuration
     */
    public MaskedRollingFileWriter(final Map<String, String> properties) throws IOException
    {
        super(properties);
     ...
     *
     * @param data Byte array to output
     ...
     *
     * @throws IOException Flushing failed
     */
     ...
     * @throws InterruptedException Interrupted while waiting for the converter
     */
    ...
    private List<FileTuple> getAllFileTuplesWithoutLinks(final String backupSuffix)
    {
                ...
                && !RuntimeProvider.isAndroid())
        {
            ...
            {
                if (fileLink.equals(iterator.next()
                                            .getOriginal()))
                {
                    iterator.remove();
                    break;
     ...
     * @param append An already existing file should be continued
     * @param buffered Output should be buffered
     ...
     *
     * @param files All original and backup files
     ...
     *
     * @param property Nullable string with policies to create
     ...
     *
     * @param property Nullable string with converter to create
     ...
     * @param policies Policies that should be applied
     ...
     *
     * @param files All original and backup files
     * @param count Number of log files to keep
     */
